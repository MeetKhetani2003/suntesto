...
export default function CreateProductPage() {
  ...
  useEffect(() => {
    async function fetchCategories() {
      try {
        ...
        console.error("Failed to load categories in product creation form:", err);
      }
    }
    fetchCategories();
  }, []);
  ...
  const [originalPrice, setOriginalPrice] = useState<number | "">(180);
  ...
  // Image File Upload Handler (GridFS)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (costPrice === "" || originalPrice === "" || price === "") {
      setError("Please fill out all 3 price fields.");
      setSubmitting(false);
      return;
    }
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="bg-white p-6 md:p-8 rounded-3xl border border-black/5 shadow-sm space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="hidden">
              ...
              <input
                type="text"
                required
                placeholder="freeze-dried-strawberry"
                value={slug}
          ...
          <div>
            ...
            <input
              type="text"
              placeholder="e.g. 100% natural, crisp strawberry crunch"
              value={subtitle}
          ...
          <div>
            ...
            <textarea
              rows={3}
              placeholder="Describe the fruit snack taste, process, and nutrition benefits..."
              value={description}
        ...
        {/* ── 2. Pricing Tiers Card (Client Cost vs MRP vs Sale) ── */}
        <div className="bg-white p-6 md:p-8 rounded-3xl border border-black/5 shadow-sm space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-purple-50/50 p-4 rounded-2xl border border-purple-100">
              ...
              <p className="text-[10px] font-semibold text-purple-800/70 mt-1.5">
                🔒 Brand acquisition/production cost. Never shown on website.
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-4 rounded-2xl border border-black/5">
              ...
              <p className="text-[10px] font-semibold text-charcoal/60 mt-1.5">
                Shown as strikethrough (~~₹180~~) on public product card.
              </p>
            </div>
            ...
            <div className="bg-emerald-50/50 p-4 rounded-2xl border border-emerald-100">
              ...
              <p className="text-[10px] font-semibold text-emerald-800/70 mt-1.5">
        ...
        {/* ── 3. Inventory Stock Control Card ──────────────────── */}
        <div className="bg-white p-6 md:p-8 rounded-3xl border border-black/5 shadow-sm space-y-6">
          <h3 className="font-primary font-black text-lg uppercase text-charcoal border-b border-black/5 pb-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              />
              <p className="text-[11px] font-semibold text-charcoal/50 mt-1">
                Setting this to 0 will automatically mark the item as &ldquo;Out of Stock&rdquo;.
              </p>
            </div>
            ...
            <div>
              ...
              />
              <p className="text-[11px] font-semibold text-charcoal/50 mt-1">
                Triggers warning badge on Admin dashboard when stock drops to or below this count.
              </p>
            </div>
          </div>
        </div>

        {/* ── 4. Media Upload (GridFS) ──────────────────── */}
        <div className="bg-white p-6 md:p-8 rounded-3xl border border-black/5 shadow-sm space-y-6">
          <div className="border-b border-black/5 pb-3 flex items-center justify-between">
            <h3 className="font-primary font-black text-lg uppercase text-charcoal">
              4. Media & Image Upload
            </h3>
            <span className="bg-blue-100 text-blue-800 text-[10px] font-bold uppercase px-3 py-1 rounded-full">
              Local DB Hosted
            </span>
          </div>
